...
For this exercise you'll use precinct-level data from the 2016 presidential election to visualize relationships between variables. This data comes from the [MIT Election Data and Science Lab](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/VOQCHQ). This example page will be incredibly useful for you:
...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `exercise-7.Rproj`: [{{< fa file-archive >}} `07-exercise.zip`](/projects/07-exercise.zip)
   ...
   (Alternatively, you can open the project named "Exercise 7" on Posit.cloud and complete the assignment in your browser without needing to install anything. [This link should take you to the project](https://posit.cloud/spaces/401677/content/6336978)—if it doesn't, log in and look for the project named "Exercise 7".)

2. Rename the R Markdown file named `your-name_exercise-7.Rmd` to something that matches your name and open it in RStudio.

3. Complete the tasks given in the R Markdown file. 

   Fill out code in the empty chunks provided (you can definitely copy, paste, and adapt from other code in the document or [the example page](/example/07-example.qmd)—don't try to write everything from scratch!).
