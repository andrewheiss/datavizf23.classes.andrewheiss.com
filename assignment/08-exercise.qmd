...
[The example for this week's session](/example/08-example.qmd) will be ***incredibly*** helpful for this exercise. Reference it.
...
For extra fun times, if you feel like it, create a bump chart showing something from the unemployment data (perhaps the top 10 states or bottom 10 states in unemployment?) Adapt the code in the [example for this week's session](/example/08-example.qmd).
