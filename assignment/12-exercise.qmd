...
The [example from this week's session](/example/12-example.qmd) shows how to load and plot shapefiles and will be incredibly helpful as you do this exercise.
