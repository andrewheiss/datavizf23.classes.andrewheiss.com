...
In your exercise this week you'll visualize trends in time using one of three different real-world datasets. [In the example](/example/11-example.qmd) I demonstrate how to remove seasonality from time series data, which is a useful skill, but *not always applicable* to every time series dataset. If there's no seasonality in your data, you don't need to remove it.
