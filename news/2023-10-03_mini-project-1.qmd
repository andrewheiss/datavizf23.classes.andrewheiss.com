...
Mini project 1 is due in less than two weeks, so it's a good time to start thinking about it. [The complete instructions are accessible here](/assignment/01-mini-project.qmd), along with starter code that should help you clean and prepare the data, and the rubric I'll use to grade the project.
